...
NOTE: La page Ressources exclut les ressources Amazon FSx for NetApp ONTAP car les utilisateurs ne peuvent pas les associer à un rôle.  Consultez-les sur la page *Systèmes* ou depuis la section Charges de travail.
