...
* *Administrateur de la reprise après sinistre* : Effectuez les actions nécessaires.
* *Administrateur de basculement en cas de sinistre* : Effectuer des basculements et des migrations.
* *Administrateur de l'application de reprise après sinistre* : Créer des plans de réplication. Modifier les plans de réplication. Démarrer les tests de basculement.
* *Visionneuse de reprise après sinistre* : Affichage des informations uniquement.
