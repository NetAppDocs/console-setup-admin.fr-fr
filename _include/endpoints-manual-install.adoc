...
* Les points de terminaison mentionnés dans l'option 1 sont pris en charge à partir de la version 3.9.47 de l'agent Console. Aucune compatibilité ascendante n'est assurée avec les versions précédentes de l'agent Console.
