...
Notez que vous (le client) n'avez pas besoin d'arrêter de services sur l'hôte de l'agent Console lors de l'application de mises à jour de sécurité mineures.
