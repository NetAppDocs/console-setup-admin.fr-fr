...
| link:reference-iam-platform-roles.html#super-admin-roles["Super spectateur"] | Ce rôle confère à l'utilisateur un sous-ensemble de rôles de visionneuse. Il est conçu pour les petites organisations qui n'ont pas forcément besoin de répartir les responsabilités de la console entre plusieurs utilisateurs. 
|===
...
| link:reference-iam-gcnv-roles.html["Visionneuse de Google Cloud NetApp Volumes"] | Les utilisateurs disposant du rôle utilisateur Google Cloud NetApp Volumes peuvent consulter Google Cloud NetApp Volumes. 
...
| link:reference-iam-backup-rec-roles.html["Administrateur de restauration de sauvegarde et de récupération"] | Restaurez les charges de travail dans NetApp Backup and Recovery. 


| link:reference-iam-backup-rec-roles.html["Administrateur de clone de sauvegarde et de récupération"] | Clonez les applications et les données dans NetApp Backup and Recovery. 
