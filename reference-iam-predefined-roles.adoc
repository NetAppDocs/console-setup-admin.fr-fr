...
| link:reference-iam-gcnv-roles.html["Utilisateur de Google Cloud NetApp Volumes"] | Les utilisateurs disposant du rôle utilisateur Google Cloud NetApp Volumes peuvent consulter Google Cloud NetApp Volumes. 
