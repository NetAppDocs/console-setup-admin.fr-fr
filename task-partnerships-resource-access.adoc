...
* link:reference-iam-predefined-roles.html["Visionneuse de classification des données"]
...
* link:reference-iam-ransomware-roles.html["Administrateur de la résilience aux ransomwares"]
* link:reference-iam-ransomware-roles.html["Visionneuse de résilience aux ransomwares"]
* link:reference-iam-ransomware-roles.html#user-behavior-roles["Comportement utilisateur de Ransomware Resilience administrateur"]
* link:reference-iam-ransomware-roles.html#user-behavior-roles["Visualiseur de comportement utilisateur de Ransomware Resilience"]
