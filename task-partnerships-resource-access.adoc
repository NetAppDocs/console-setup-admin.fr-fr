...
---
= Fournir un accès aux ressources aux utilisateurs partenaires dans la NetApp Console
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
* link:reference-iam-keystone-roles.html["Administrateur Keystone"]
* link:reference-iam-keystone-roles.html["Visionneuse Keystone"]
...
. Sélectionnez le menu Actions image:icon-action.png["une icône avec trois points verticaux"] à côté du partenariat établi que vous souhaitez consulter et sélectionnez *Afficher les détails*.
+
