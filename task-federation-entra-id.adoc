...
Vous pouvez configurer une connexion fédérée avec Microsoft Entra ID pour activer l'authentification unique (SSO) pour la Console. La procédure consiste à configurer votre Microsoft Entra ID pour qu'il approuve la Console en tant que fournisseur de services, puis à créer la connexion dans la Console.
...
. Créez la connexion avec Microsoft Entra ID.
+
.. Saisissez l'identifiant client et le secret client que vous avez créés à l'étape précédente.
