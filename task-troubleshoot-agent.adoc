...
== Vérifiez l'accès au réseau et aux ports pour l'agent Console
...
Effectuez des vérifications de configuration sur les agents Console depuis la Console ou la console de maintenance des agents pour vous assurer qu'ils peuvent accéder aux points de terminaison requis et que les ports requis sont ouverts.

Vous pouvez également effectuer des vérifications de configuration à l'aide de la console de maintenance de l'agent.link:reference-agent-maint-console-config-checker.html["Apprenez-en davantage sur l'utilisation de la commande de validation de config-checker."]
