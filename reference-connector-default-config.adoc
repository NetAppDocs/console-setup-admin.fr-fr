...
Les détails de configuration suivants s'appliquent si vous avez déployé un agent de console à partir de la console NetApp , à partir de la place de marché de votre fournisseur de cloud ou si vous avez installé manuellement un agent de console sur un hôte Linux local disposant d'un accès Internet.
...
* Le nom d'utilisateur de l'instance EC2 Linux est ubuntu (pour les agents créés avant mai 2023, le nom d'utilisateur était ec2-user).
