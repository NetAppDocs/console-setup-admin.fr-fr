...
| *config.deployments.create* .15+| Pour déployer l'instance de machine virtuelle Cloud Volumes ONTAP à l'aide de Google Cloud Infrastructure Manager. | Oui | Non | Non 
...
| *config.deployments.list* | Non | Oui | Non 


| *config.deployments.lock* | Non | Oui | Non 


| *config.deployments.update* | Non | Oui | Non 
...
| *compute.forwardingRules.create* | Créez des règles de transfert pour le routage du trafic vers les services backend. | Non | Oui | Non 


| *compute.forwardingRules.delete* | Supprimer les règles de transfert existantes. | Non | Oui | Non 


| *compute.forwardingRules.get* | Récupérer les détails des règles de redirection existantes. | Non | Oui | Non 


| *compute.forwardingRules.setLabels* | Définir ou mettre à jour les étiquettes des règles de transfert pour l'organisation. | Non | Oui | Non 


| calculer.globalOperations.get | Pour obtenir l'état des opérations. | Oui | Oui | Non 


| *compute.healthChecks.create* .4+| Créer et gérer des contrôles d'intégrité pour surveiller l'état des services backend. | Non | Oui | Non 


| *compute.healthChecks.delete* | Non | Oui | Non 


| *compute.healthChecks.get* | Non | Oui | Non 


| *compute.healthChecks.useReadOnly* | Non | Oui | Non 
...
| *compute.instances.use* | Utiliser des instances de machines virtuelles (opérations de démarrage, d'arrêt et de connexion). | Non | Oui | Non 
...
| *compute.resourcePolicies.create* .3+| Créer et gérer des politiques de ressources pour la gestion automatisée des ressources. | Non | Oui | Non 


| *compute.resourcePolicies.delete* | Non | Oui | Non 


| *compute.resourcePolicies.get* | Non | Oui | Non 
...
| *iam.serviceAccounts.create* | Oui | Non | Non 
...
| *compute.addresses.createInternal* | Créer des adresses IP internes au sein du réseau VPC pour l'allocation des ressources. | Non | Oui | Non 


| *compute.addresses.deleteInternal* | Suppression des adresses IP internes pour le nettoyage des ressources. | Non | Oui | Non 


| *compute.addresses.setLabels* | Mettre à jour les étiquettes de la ressource Adresse. | Non | Oui | Non 


| *compute.addresses.useInternal* | Utilisez les adresses IP internes pour les communications réseau. | Non | Oui | Non 
...
| *compute.regionBackendServices.update* | Oui | Oui | Non 
...
| *compute.instanceGroups.create* | Non | Oui | Non 


| *compute.instanceGroups.delete* | Non | Oui | Non 


| *compute.instanceGroups.update* | Non | Oui | Non 


| *compute.instanceGroups.use* | Non | Oui | Non 
