...
summary: 'Le mode privé est généralement utilisé avec des environnements locaux qui n’ont pas de connexion Internet et avec des régions cloud sécurisées, notamment AWS Secret Cloud, AWS Top Secret Cloud et Azure IL6.  Le mode privé n"est pas encore disponible avec la console NetApp .  NetApp continue de prendre en charge ces environnements avec l"interface héritée BlueXP . lien :<lien doc vers PDF>' 
---
...
| Sauvegarde et récupération | Ouihttps://docs.netapp.com/us-en/bluexp-backup-recovery/prev-ontap-protect-journey.html#support-for-sites-with-no-internet-connectivity["Afficher la liste des destinations de sauvegarde prises en charge pour les données de volume ONTAP"^] 
