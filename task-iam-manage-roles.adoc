...
Les utilisateurs disposant du rôle *Administrateur d'organisation* ou *Administrateur de dossier ou de projet* ont la responsabilité d'attribuer des rôles à d'autres utilisateurs. Vous pouvez attribuer des rôles d’accès sur la base d’un projet ou d’un dossier. Attribuer les rôles d'accès par projet ou dossier.  Par exemple, attribuez le rôle d'administrateur Ransomware Resilience à un utilisateur pour un projet et le rôle d'administrateur SnapCenter pour un autre.  Pour attribuer à un utilisateur le rôle d'administrateur Ransomware Resilience pour tous les projets d'un dossier, attribuez le rôle au niveau du dossier.
...
Attribuez des rôles conformément à votre stratégie IAM pour améliorer la sécurité.  Les rôles IAM limitent l'accès des utilisateurs aux seules ressources nécessaires.
...
Lorsque vous ajoutez un membre à votre organisation, vous êtes invité à lui attribuer un rôle. Vous pouvez vérifier les rôles qui leur sont actuellement attribués.
