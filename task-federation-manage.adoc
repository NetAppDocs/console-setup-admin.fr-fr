...
[role="lead"]
Vous pouvez gérer votre fédération dans la NetApp Console. Vous pouvez la désactiver, mettre à jour les identifiants expirés, ainsi que la supprimer si vous n'en avez plus besoin.
...
[NOTE]
====
* Si vous avez configuré la fédération à l’aide de NetApp Cloud Central, importez-la via la page *Fédération* pour la gérer dans la console.link:task-federation-import.html["Apprenez à importer votre fédération"]
* Vous pouvez consulter les événements de gestion des fédérations, tels que l'activation, la désactivation et la mise à jour des fédérations, sur la page Audit. link:task-monitor-cm-operations.html["En savoir plus sur les opérations de surveillance dans la NetApp Console."]
...
. Sélectionnez *Administration > Identité et accès*.
. Sélectionnez l'onglet *Fédération*.
. Sélectionnez le menu Actions image:button_3_vert_dots.png["une icône avec trois points verticaux"] à côté de la fédération que vous souhaitez tester et sélectionnez *Tester la connexion*.
...
. Sélectionnez *Administration > Identité et accès*.
. Sélectionnez l'onglet *Fédération*.
. Sélectionnez le menu Actions image:button_3_vert_dots.png["une icône avec trois points verticaux"] à côté de la fédération que vous souhaitez désactiver et sélectionnez *Désactiver*.
...
. Sélectionnez le menu Actions image:button_3_vert_dots.png["une icône avec trois points verticaux"] à côté de la fédération que vous souhaitez supprimer et sélectionnez *Supprimer*.
