...
Vous pouvez également vérifier votre organisation afin de la lier à l'identité de votre compte professionnel NetApp pour une gouvernance cohérente entre les systèmes NetApp. link:concept-verified-organization.html["Découvrez les organisations vérifiées dans la NetApp Console"].
