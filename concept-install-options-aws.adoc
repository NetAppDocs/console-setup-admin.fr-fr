...
* link:task-install-connector-aws-bluexp.html["Créez l'agent de console directement depuis la console"](c'est l'option standard)
+
Cette action lance une instance EC2 exécutant Linux et le logiciel agent de console dans un VPC de votre choix.

* link:task-install-connector-aws-marketplace.html["Créer un agent de console à partir d'AWS Marketplace"]
+
