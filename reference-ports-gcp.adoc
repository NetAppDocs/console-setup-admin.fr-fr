...
summary: 'Les règles du pare-feu Google Cloud pour l"agent nécessitent des règles de trafic entrant et sortant. La NetApp Console crée automatiquement ce groupe de sécurité lorsque vous créez un agent Console à partir de la Console. Pour les autres options d"installation, vous devez configurer ce groupe de sécurité manuellement.' 
---
= NetApp Console règles de pare-feu de l'agent dans Google Cloud
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Les règles du pare-feu Google Cloud pour l'agent nécessitent des règles de trafic entrant et sortant. La NetApp Console crée automatiquement ce groupe de sécurité lorsque vous créez un agent Console à partir de la Console. Pour les autres options d'installation, vous devez configurer ce groupe de sécurité manuellement.
...
| DNS | UDP | 53 | DNS | Utilisé pour la résolution DNS par Data Classification 
|===