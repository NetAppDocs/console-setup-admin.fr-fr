...
Par exemple, si vous utilisez Microsoft Entra ID, vous pouvez suivre les étapes décrites dans la documentation Microsoft link:https://learn.microsoft.com/en-us/entra/fundamentals/add-custom-domain["Ajoutez un domaine avec Microsoft Entra ID"].
