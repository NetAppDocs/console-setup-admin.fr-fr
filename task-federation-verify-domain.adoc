...
Ce processus de vérification de domaine est différent de la vérification d'organisation. link:task-verify-organization.html["Apprenez comment vérifier votre organisation"].
