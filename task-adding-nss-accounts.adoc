...
---
= Gérer les informations d'identification NSS associées à la console NetApp
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
Vous ne pouvez pas supprimer un compte actuellement associé à un système Cloud Volumes ONTAP .  Vous devez d’abord<<attach-system-nss-account,attacher ces systèmes à un compte NSS différent>> .
