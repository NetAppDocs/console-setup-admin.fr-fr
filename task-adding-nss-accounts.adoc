...
.Étapes
. Sélectionnez *Administration > Support*.
...
+
Cette option vous invite à vous reconnecter. Veuillez noter que le jeton de ces comptes expire après 90 jours. Vous recevrez une notification à ce sujet.
