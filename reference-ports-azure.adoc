...
summary: 'Le groupe de sécurité Azure de l"agent requiert des règles de trafic entrant et sortant. La NetApp Console crée automatiquement ce groupe de sécurité lorsque vous créez un agent Console depuis la Console. Pour les autres options d"installation, vous devez configurer ce groupe de sécurité manuellement.' 
---
= NetApp Console : règles de groupe de sécurité de l'agent dans Azure
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Le groupe de sécurité Azure de l'agent requiert des règles de trafic entrant et sortant. La NetApp Console crée automatiquement ce groupe de sécurité lorsque vous créez un agent Console depuis la Console. Pour les autres options d'installation, vous devez configurer ce groupe de sécurité manuellement.
...
| DNS | UDP | 53 | DNS | Utilisé pour la résolution DNS par la NetApp Console 
|===