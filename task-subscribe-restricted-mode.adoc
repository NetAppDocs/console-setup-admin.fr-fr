...
---
= Abonnez-vous à NetApp Intelligent Services en mode restreint de NetApp Console
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
.Avant de commencer
Vous devez avoir préalablement déployé un agent Console pour vous abonner aux services de données. Vous devez associer un abonnement Marketplace aux identifiants cloud connectés à un agent Console.
