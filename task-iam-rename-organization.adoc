...
---
= Renommez votre organisation NetApp Console et obtenez des identifiants
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: 
...
[role="lead"]
Votre organisation NetApp Console possède un nom et un identifiant. Vous pouvez choisir un nom pour votre organisation afin de faciliter son identification. Vous aurez peut-être également besoin de l'identifiant de l'organisation pour les appels d'API.
...
Vous pouvez renommer votre organisation. Cela s'avère utile si vous gérez plusieurs organisations.
...
+
image:screenshot-iam-edit-organization.png["Capture d'écran de la page Organisation montrant l'icône Actions et l'option Modifier l'organisation."]
