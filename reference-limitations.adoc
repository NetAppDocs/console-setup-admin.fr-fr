...
La console ne prend pas en charge les configurations de pare-feu pour lesquelles le décryptage SSL est activé. Si le décryptage SSL est activé, des messages d'erreur apparaissent dans la console et l'instance de l'agent s'affiche comme *Déconnectée*.
