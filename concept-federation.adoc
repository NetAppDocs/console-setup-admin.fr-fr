...
---
= Découvrez la fédération d'identités dans la NetApp Console
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
NOTE: La fédération n'est pas disponible lorsque NetApp Console est en mode privé. link:concept-modes.html["En savoir plus sur les modes NetApp Console"^].
...
.Protocoles
* link:task-federation-adfs.html["Services de fédération Active Directory (AD FS)"]
* link:task-federation-saml.html["Fournisseurs d'identité SAML (Security Assertion Markup Language)"]


.Fournisseurs d'identité
* link:task-federation-entra-id.html["Identifiant Microsoft Entra"]
* link:task-federation-ping.html["PingFédéré"]
...
[role="quick-margin-para"]
Configurez votre fournisseur d'identité pour faire confiance à NetApp en créant une nouvelle application et en fournissant des informations telles que l'URL ACS, l'ID d'entité ou d'autres informations d'identifiant. Les informations du fournisseur de services varient selon le fournisseur d'identité, veuillez donc consulter la documentation de votre fournisseur d'identité pour plus de détails. Vous devrez collaborer avec votre administrateur IdP pour terminer cette étape.
...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-4.png["Quatre"]Testez votre fédération dans la NetApp Console
[role="quick-margin-para"]
...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-5.png["Cinq"]Activez votre connexion dans la NetApp Console
[role="quick-margin-para"]
