...
https://docs.netapp.com/us-en/bluexp-fsx-ontap/requirements/task-setting-up-permissions-fsx.html["Découvrez comment ajouter des informations d'identification AWS à la console pour Amazon FSx for ONTAP"^]
