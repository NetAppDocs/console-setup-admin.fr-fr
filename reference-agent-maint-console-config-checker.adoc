...
`--validationTypes <comma-separated list validation types to run>` --*OBLIGATOIRE*-- Choisissez un ou plusieurs types de validation à exécuter. Les types de validation valides sont :
