...
. Vous pouvez également ajouter des membres de l'organisation au partenariat et sélectionner *Appliquer*.
+
...
.Résultat
Le partenariat que vous avez approuvé affiche désormais le statut *Établi*. Les utilisateurs ayant le rôle *Administrateur du partenariat* ou *Consultant du partenariat* dans l'une ou l'autre organisation peuvent consulter le partenariat.
...
. Sélectionnez *Administration > Identité et accès*.
. Sélectionnez l'onglet *Partenariats*.
. Sélectionnez l’onglet *Partenariats initiés* ou *Partenariats reçus*.
...
. Sélectionnez *Administration > Identité et accès*.
. Sélectionnez l'onglet *Partenariats*.
. Sélectionnez l'onglet *Partenariats initiés*.
. Consultez le tableau correspondant qui affiche les partenariats et leurs statuts.
