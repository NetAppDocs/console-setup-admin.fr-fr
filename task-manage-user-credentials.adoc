...
Par défaut, les utilisateurs ne sont pas invités à saisir leurs identifiants ONTAP pour accéder à ONTAP System Manager. Cependant, un administrateur de la Console (avec le rôle d'administrateur de l'organisation) peut configurer la Console pour inviter les utilisateurs à saisir leurs identifiants ONTAP. Lorsque ce paramètre est activé, les utilisateurs doivent saisir leurs identifiants ONTAP à chaque fois.
