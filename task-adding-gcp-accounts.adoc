...
---
= Associez les informations d'identification de l'agent de la console à votre abonnement Google Cloud
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Lorsque vous créez un agent de console dans Google Cloud, vous pouvez utiliser les informations d'identification associées pour vous abonner aux NetApp Intelligent Services, qui incluent Cloud Volumes ONTAP et les services de données NetApp .  Vous devez associer l'abonnement à l'agent dont vous souhaitez utiliser les informations d'identification pour payer les services.
...
Le remplacement de l'abonnement actuel du marché par un nouveau met à jour l'abonnement pour les systèmes Cloud Volumes ONTAP existants et nouveaux.
...
L'abonnement aux services de données NetApp via Google Cloud Marketplace peut échouer en raison d'autorisations incorrectes ou d'une redirection manquée vers la console. Si cela se produit, suivez les étapes suivantes pour terminer le processus d’abonnement.
