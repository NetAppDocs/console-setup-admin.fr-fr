...
summary: La manière dont vous vous connectez à la console NetApp dépend du mode de déploiement que vous utilisez. 
---
...
[role="lead"]
La manière dont vous vous connectez à la console NetApp dépend du mode de déploiement que vous utilisez.
...
.Mode standard
--
Après vous être inscrit à la console NetApp , vous pouvez vous connecter à partir de la console Web pour commencer à gérer vos données et votre infrastructure de stockage.

.À propos de cette tâche
Vous pouvez vous connecter à la console NetApp en utilisant l’une des options suivantes :
...
* Une connexion à la console NetApp à l'aide de votre adresse e-mail et d'un mot de passe
* Une connexion fédérée
+
