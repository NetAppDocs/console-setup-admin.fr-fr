...
Vous devez disposer des autorisations d'administrateur d'organisation ou de super administrateur pour gérer l'identité et le contrôle d'accès de votre organisation. Avec les autorisations d'administrateur de dossier ou de projet, vous pouvez uniquement gérer les dossiers et les projets auxquels vous avez accès.
...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-5.png["Cinq"]Vérifiez votre organisation (facultatif)
[role="quick-margin-para"]
Si votre équipe utilise la vérification d'organisation, associez votre organisation Console à l'identité de votre compte professionnel NetApp.

[role="quick-margin-para"]
link:task-verify-organization.html["Apprenez comment vérifier votre organisation"].
...
* link:concept-verified-organization.html["Découvrez les organisations vérifiées dans la NetApp Console"]
