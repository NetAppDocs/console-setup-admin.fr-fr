...
---
= Démarrer avec l'identité et l'accès dans la console NetApp
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="quick-margin-para"]
Ajoutez ou découvrez des ressources (systèmes) dans la console.  Les membres de l’organisation gèrent les systèmes à partir d’un projet.
...
* https://docs.netapp.com/us-en/bluexp-e-series/index.html["Systèmes de la série E"^]
...
* link:concept-identity-and-access-management.html["En savoir plus sur la gestion des identités et des accès dans la console NetApp"]
