...
* Pour les nouveaux déploiements d'agents de console à partir de la console ou à l'aide https://docs.netapp.com/us-en/bluexp-automation/automate/overview.html["Scripts Terraform"^] IMDSv2 est activé par défaut sur l'instance EC2.
...
.. https://docs.netapp.com/us-en/bluexp-cloud-volumes-ontap/task-managing-state.html["Arrêter et démarrer les instances Cloud Volumes ONTAP"^]
