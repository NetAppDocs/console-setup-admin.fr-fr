...
---
= Autorisations Azure pour l’agent NetApp Console
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
.3+| Utilisez les groupes de machines virtuelles identiques en mode d'orchestration flexible pour spécifier des zones spécifiques pour Cloud Volumes ONTAP | Microsoft.Compute/virtualMachineScaleSets/write | Oui | Non | Non 
