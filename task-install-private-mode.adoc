...
---
= Déployez l’agent NetApp Console en mode privé
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
+
** Sélectionnez la version compatible avec le mode privé. Consultez la link:whats-new.html["notes de version"] pour connaître la dernière version prise en charge.
** Téléchargez le programme d'installation hors ligne pour les réseaux sans accès à Internet.
...
--
Fournissez à l'agent de la console les identifiants pour le principal de service Azure que vous avez configuré précédemment.
