...
[NOTE]
====
* La console envoie des notifications par e-mail concernant l’agent, les licences et les abonnements, NetApp Copy and Sync, NetApp Backup and Recovery et NetApp Ransomware Resilience.
...
.Étapes
. Sélectionnez *Administration > Paramètres des notifications*.
