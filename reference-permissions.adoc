...
| Déployer un agent de console à partir de la console | L'utilisateur qui crée un agent de console à partir de la console a besoin d'autorisations spécifiques pour déployer l'instance dans AWS. | link:task-install-connector-aws-bluexp.html#aws-permissions-agent["Configurer les autorisations AWS"] 
